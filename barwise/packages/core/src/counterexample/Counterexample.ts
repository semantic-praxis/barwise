 ...
 * `forbidden` population back through `populationValidationRules` reports
...
export interface Counterexample {
  /** The fact type the forbidden population belongs to. */
  ...
  /** The minimal sample population the constraint forbids. */
  readonly forbidden: Population;
