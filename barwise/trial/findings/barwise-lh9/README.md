# barwise-lh9: the OpenAPI importer writes duplicate role ids

```sh
barwise import model trial/findings/barwise-lh9/api.json --format openapi --output /tmp/api.orm.yaml
