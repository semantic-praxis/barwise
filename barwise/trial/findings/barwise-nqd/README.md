# barwise-nqd: merge fails on a fact-type rename without saying why

```sh
barwise merge trial/findings/barwise-nqd/base.orm.yaml trial/findings/barwise-nqd/incoming.orm.yaml --output /tmp/merged.orm.yaml
```
