# barwise-jjd: `import sql` reads foreign-key targets, not tables

```sh
barwise import sql trial/findings/barwise-jjd/schema.sql --dialect postgres
barwise import sql trial/findings/barwise-jjd/schema.sql --dialect oracle
```
