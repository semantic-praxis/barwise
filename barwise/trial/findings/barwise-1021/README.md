# barwise-1021: `import sql` reads foreign-key targets, not tables

```sh
barwise import sql trial/findings/barwise-1021/schema.sql --dialect postgres
barwise import sql trial/findings/barwise-1021/schema.sql --dialect oracle
```
