# barwise-rkm: a rename reported as removal plus addition

```sh
barwise diff trial/findings/barwise-rkm/before.orm.yaml trial/findings/barwise-rkm/after.orm.yaml --format json
```
