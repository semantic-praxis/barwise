# barwise-1034: the OpenAPI importer writes duplicate role ids

```sh
barwise import model trial/findings/barwise-1034/api.json --format openapi --output /tmp/api.orm.yaml
