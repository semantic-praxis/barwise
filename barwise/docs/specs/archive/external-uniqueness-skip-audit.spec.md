...
Status: Implemented -- the skip taxonomy is encoded in
inferExternalUniquenessJoin returning undefined on ambiguity; the
flagged coverage gap is closed by
tests/validation/externalUniquenessPopulation.test.ts.
Created: 2026-06-17
