...
Status: Superseded 2026-07-25 -- the deterministic certification and
judging mechanism shipped as the modeling gym (@barwise/learn); the
story-elimination device (constraint induction as detective cases)
survives as a candidate gym content pack, noted in
modeling-gym.spec.md.
Created: 2026-07-01
