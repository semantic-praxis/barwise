...
Status: Implemented -- boundedTextResult (8KB inline cap,
spill-to-file with preview) in packages/mcp/src/workspace/response.ts,
wired through the diagram, export, and verbalize tools.
Created: 2026-05-18
