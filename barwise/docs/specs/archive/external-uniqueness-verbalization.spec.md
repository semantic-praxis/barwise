...
Status: Implemented -- constraint verbalization resolves roles
model-wide (verbalization/constraints/phase1.ts via model.findRole),
not against the owner fact type alone.
Created: 2026-06-17
