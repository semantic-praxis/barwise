...
Status: Implemented -- inferExternalUniquenessJoin
(core/src/externalUniqueness.ts), population validation
(rules/population/uniqueness.ts), and counterexample support.
Created: 2026-06-17
