...
Status: Implemented -- provider modules load their SDKs via lazy
dynamic import on first use (packages/llm/src/providers/), so
importing the factory pulls in neither SDK.
Created: 2026-06-17
