...
Status: Implemented -- release.yml builds and attaches the VSIX, the
CLI and MCP bundles, and SHA256SUMS, and refreshes the rolling edge
pre-release on every push to main.
Created: 2026-06-17
