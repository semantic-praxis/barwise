...
Status: Superseded 2026-07-25 -- the deterministic-judge mechanism
shipped as the modeling gym (@barwise/learn, PR #258, see
modeling-gym.spec.md); the narrative pedagogy is carried by
modeling-tutorial.spec.md under the learning-design standard.
Created: 2026-07-01
